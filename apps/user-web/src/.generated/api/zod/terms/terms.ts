...
export const termsControllerGetUserTermsV1QueryPageDefault = 1;
export const termsControllerGetUserTermsV1QueryLimitDefault = 20;
export const termsControllerGetUserTermsV1QueryLimitMax = 100;



export const TermsControllerGetUserTermsV1QueryParams = zod.object({
  "sort": zod.array(zod.string()).optional(),
  "direction": zod.array(zod.enum(['asc', 'desc'])).optional(),
  "search": zod.string().optional(),
  "page": zod.number().default(termsControllerGetUserTermsV1QueryPageDefault),
  "limit": zod.number().max(termsControllerGetUserTermsV1QueryLimitMax).default(termsControllerGetUserTermsV1QueryLimitDefault),
  "groupId": zod.string().optional()
})

export const TermsControllerGetUserTermsV1Response = zod.object({
  "success": zod.boolean(),
  "statusCode": zod.number(),
  "path": zod.string(),
  "requestId": zod.string(),
...
export const TermsControllerGetUserTermGroupsV1Response = zod.object({
  "success": zod.boolean(),
  "statusCode": zod.number(),
  "path": zod.string(),
  "requestId": zod.string(),
