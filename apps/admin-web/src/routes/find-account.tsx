            ...
            <div className="grid grid-rows-[auto_auto_1fr] gap-6">
              ...
              <div className="grid grid-cols-2 rounded-lg bg-muted p-1">
                <button
                  ...
                  className={activeTab === 'id'
                    ? `
                      rounded-md bg-background px-3 py-2 text-sm font-medium
              ...
              {activeTab === 'id' && (
                foundAccounts
                  ? (
                    <div className="
                      grid h-full min-h-0 grid-rows-[auto_1fr_auto] gap-4
                    "
                    >
                      <div className="
                        ...
                        {foundAccounts.map((account) => (
                          ...
                          >
                            <div className="grid gap-1">
                              <span className="font-mono text-sm font-semibold">{account.maskedEmail}</span>
                              <span className="
                  ...
                  : (
                    <idForm.AppForm>
                      <FormLayout
                        ...
                        className="h-full grid-rows-[1fr_auto] gap-4"
                      >
              ...
              {activeTab === 'password' && (
                passwordResetRequested
                  ? (
                    <div className="
                      grid h-full min-h-0 grid-rows-[1fr_auto] gap-4 text-center
                    "
                    >
