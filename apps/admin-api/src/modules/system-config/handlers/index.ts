...
export const SYSTEM_CONFIG_HANDLERS = [GetSystemConfigHandler, GetHolidaysHandler, UpdateSystemConfigHandler, TestWebhookHandler, TestEmailHandler, TestSmsHandler, TestPushHandler, TestMessengerHandler, CreateOAuthIconPresignedUrlHandler];
