...
import { AccountRecoveryEmailConfigResponseDto, TestAccountRecoveryEmailResponseDto, UpdateAccountRecoveryEmailConfigRequestDto } from '#/modules/system-config/dto/account-recovery-email-config.dto';

const CONFIG_CODE = 'email';
...
export class SystemConfigService {
  ...
  async getResponse(): Promise<AccountRecoveryEmailConfigResponseDto> {
  ...
  async update(input: UpdateAccountRecoveryEmailConfigRequestDto): Promise<AccountRecoveryEmailConfigResponseDto> {
  ...
  async sendTestEmail(to: string): Promise<TestAccountRecoveryEmailResponseDto> {
    const config = await this.getValue();
