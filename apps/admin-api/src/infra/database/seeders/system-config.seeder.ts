...
const DEFAULT_CONFIGS: Array<{ code: SystemConfigCode, description: string, isPublic: boolean, value: Record<string, unknown> }> = [
  ...
  { code: SystemConfigCode.INQUIRY, isPublic: false, description: '미응답 문의 감지, 답변 완료 후 자동 종료 시간 및 운영자 알림 웹훅 설정', value: { unansweredThresholdMinutes: 10, autoCloseHours: 72, notification: { enabled: false, type: 'SLACK', cooldownMinutes: 10, webhookUrl: '' } } },
