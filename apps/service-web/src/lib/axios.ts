...
const AUTH_TOKEN_RESPONSE_PATHS = ['/api/v1/auth/login', '/api/v1/auth/refresh'] as const;
...
async function requestRefreshToken() {
  const refreshResponse = await AXIOS_INSTANCE.post<unknown>('/api/v1/auth/refresh', {}, { withCredentials: true });
