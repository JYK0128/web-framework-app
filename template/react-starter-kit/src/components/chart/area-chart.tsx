  ...
  return (
    <div className="size-full rounded-lg border border-dashed p-4" role="status" aria-label="Loading chart">
      <svg className="size-full animate-pulse" viewBox="0 0 400 240" preserveAspectRatio="none" aria-hidden="true">
        <path d="M 8 200 Q 80 120 160 150 T 300 80 T 392 110 L 392 232 L 8 232 Z" fill="currentColor" className="text-chart-1/25" />
        <path d="M 8 215 Q 90 170 170 185 T 310 140 T 392 160 L 392 232 L 8 232 Z" fill="currentColor" className="text-chart-2/25" />
      </svg>
    </div>
  );
}
