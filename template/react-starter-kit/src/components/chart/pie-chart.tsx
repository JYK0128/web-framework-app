  ...
  return (
    <div className="flex size-full items-center justify-center rounded-lg border border-dashed" role="status" aria-label={t('common.loadingChart')}>
      <svg className="size-full animate-pulse" viewBox="0 0 200 200" aria-hidden="true">
        ...
        <circle cx="100" cy="100" r="72" fill="none" stroke="currentColor" strokeWidth="34" strokeDasharray="85 452" strokeDashoffset="-255" className="text-chart-3/25" transform="rotate(-90 100 100)" />
        <circle cx="100" cy="100" r="72" fill="none" stroke="currentColor" strokeWidth="34" strokeDasharray="60 452" strokeDashoffset="-350" className="text-chart-4/25" transform="rotate(-90 100 100)" />
      </svg>
    </div>
  );
}
