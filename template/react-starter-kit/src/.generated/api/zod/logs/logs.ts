 ...
 */
export const logsControllerGetLogsQueryLimitDefault = 30;

export const LogsControllerGetLogsQueryParams = zod.object({
  ...
  "limit": zod.number().default(logsControllerGetLogsQueryLimitDefault)
})

export const LogsControllerGetLogsResponse = zod.object({
  "success": zod.boolean(),
 ...
 */
export const LogsControllerStreamLogsResponse = zod.unknown()

/**
 * @summary 로그 단건 상세 조회
 */
export const LogsControllerGetLogByIdParams = zod.object({
  "id": zod.string()
})

export const LogsControllerGetLogByIdResponse = zod.object({
  "success": zod.boolean(),
  "statusCode": zod.number(),
  "path": zod.string(),
  "requestId": zod.string(),
