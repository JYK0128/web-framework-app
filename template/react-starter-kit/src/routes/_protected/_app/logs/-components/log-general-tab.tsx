        ...
        >
          <ActionCard.Actions>
            <Button
              ...
              title={t('logs.detail.copyRequestId')}
            >
              <Copy className="size-3.5" />
            </Button>
          </ActionCard.Actions>
