...
export const DASHBOARD_MENU_ITEMS: MenuItemConfig[] = [
  ...
  { titleKey: 'dashboard.supportManagement', descriptionKey: 'dashboard.supportManagementDescription', href: '/support-management', icon: 'clipboard-check', iconColor: 'text-cyan-600 dark:text-cyan-400', permission: 'support:manage' },
